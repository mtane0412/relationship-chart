...
- persons[].tags には人物の属性・役割を端的に表すラベルを配列で含めてください（例: ["主人公", "貴族"]）。情報がない場合は null にしてください。
- persons[].narrative.summary には人物の物語的な説明（1〜2文）を設定してください。情報がない場合は null にしてください。
- persons[].properties には人物固有の追加情報をキーバリュー形式で含めてください（例: {"年齢": 20, "職業": "学生"}）。情報がない場合は空オブジェクト {} にしてください。
